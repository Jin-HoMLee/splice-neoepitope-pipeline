...
Produces a self-contained HTML page showing:
  1. Junction provenance summary — counts of tumor_specific vs patient_specific
...
<body>
  ...
  <h2>Junction provenance summary</h2>
...
def generate_report(
    ...
    provenance_html = _df_to_html(provenance_df)
    ...
    html = _HTML_TEMPLATE.format(
        provenance_table=provenance_html,
