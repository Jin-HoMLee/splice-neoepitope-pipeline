...
**Forward link.** The documented splice-junction under-prediction is exactly what a foreignness / dissimilarity-to-self term would correct → [Issue #585](https://github.com/Jin-HoMLee/splice-neoepitope-pipeline/issues/585) (Łuksza foreignness, this morning's [Issue #572](https://github.com/Jin-HoMLee/splice-neoepitope-pipeline/issues/572) spin-off) becomes the natural splice-junction-correction follow-up rather than an orphan.
