...
### 09:27 UTC - Editor: Developer - The junction ORF-FASTA emitter for the MS re-search, and the realization that it is the general representation the k-mer path is a projection of ([PR #1259](https://github.com/Jin-HoMLee/splice-neoepitope-pipeline/pull/1259) for [Issue #1204](https://github.com/Jin-HoMLee/splice-neoepitope-pipeline/issues/1204))
