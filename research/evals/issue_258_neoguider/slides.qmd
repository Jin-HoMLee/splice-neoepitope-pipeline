...
- **Code:** [`XuegongLab/neoguider`](https://github.com/XuegongLab/neoguider) — AGPLv3 (non-profit only); paper CC-BY-NC-ND 4.0. Pre-built Docker at `quay.io/cndfeifei0/ng:v01`.
:::
...
| MHC presentation (netMHCpan + netMHCstabpan) | MHCflurry 2.x `Class1PresentationPredictor` | ❌ |
