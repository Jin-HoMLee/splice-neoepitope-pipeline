...
3. **License layering.** Repo is AGPLv3 + author-imposed commercial restriction; paper is CC-BY-NC-ND 4.0. The algorithm can be reimplemented from the paper; the *repo code* cannot be embedded in commercial use without a paid license from the corresponding author.
