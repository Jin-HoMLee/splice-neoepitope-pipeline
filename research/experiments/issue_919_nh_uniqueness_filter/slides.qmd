...
A single-chromosome index **manufactures false-unique alignments**. No refinement of the A/B fixes this - it is a property of the fixture.
:::

- Only **8%** of reads map at all (41,634 / 500,000)
- 1,926 spliced alignments carry `NH=1` - yet the unannotated junctions they yield are **99% repeat-overlapping** against a **51.9%** null
