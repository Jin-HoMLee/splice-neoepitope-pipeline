...
![ORF-stretch extraction: a 60-nt contig split at the junction breakpoint, translated in three reading frames. Each frame independently keeps its stop-free stretch that crosses the breakpoint, so one contig yields up to three mini-proteins. Shown: one illustrative frame crossing (frame 0); the other two terminate on one side and drop.](figures/emitter_schematic.png){width=88%}
