...
A **decoupled** 30-nt path (gold) reuses `assemble_contigs.py` at widened flanks and adds one new emitter rule. The production MHCflurry k-mer path (27-nt flanks, `peptide_lengths [8,9,10]`) is untouched.
...
![](figures/recovery_spectrum.png){width=74%}
