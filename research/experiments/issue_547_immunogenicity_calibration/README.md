...
**Honest caveat on AUPRG at extreme imbalance:** the same 1-in-4,000 prevalence makes the precision-gain baseline trivially easy to beat, so NCI's AUPRG saturates toward 1; read the extreme-prevalence cohort with the same caution as its lift.
