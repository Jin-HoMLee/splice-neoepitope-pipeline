...
But thin is not second-rate. We looked for stronger evidence and found none: **no splice-derived antigen has yet helped a patient in a trial** - every therapy aimed at one is still preclinical, and the neoantigen treatments that *have* shrunk tumors target mutations, not splicing. These 82 rows are the best human evidence the field has ([#1119](https://github.com/Jin-HoMLee/splice-neoepitope-pipeline/issues/1119), searched 2026-07-11).
