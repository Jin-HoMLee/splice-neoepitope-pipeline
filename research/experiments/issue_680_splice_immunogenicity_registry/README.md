...
## Coverage (96 rows, ~13 sources, 74 genes)
...
- **Sources (~13):** SNAF (Li 2024), IRIS (Pan), Kim 2025 (SF-mutant leukemia, expanded +13 via #838), Xiong 2025 (RCAN1-4), Fisher 2026, Kwok 2024, POSTN-203, Manoharan 2026 (IR-CRC), Merlotti 2023 (NSCLC exon-TE), Bigot 2021 (SF3B1 uveal melanoma, +35 - #734 IEDB mine), **Long-read UM 2023 (Cancer Immunol Res, SEPTIN6/AMZ2P1/MZT2B, +4 non-scorable - #838)**.
