...
- IEDB channel resolved 2026-07-01 (earlier fetch failures were a client-side VPN block, not IEDB): standalone tar.gz confirmed + the NetMHC-3.0-license publish-restriction surfaced (see Tier-1 #5 / §5 item 7).
