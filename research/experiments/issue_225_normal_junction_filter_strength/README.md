...
- `slides.qmd` / `slides.html` — Quarto reveal.js deck for lab seminar
- `figures/pr_curve.png` + `figures/caught_bar.png` — deck-only figures (regenerated by `figures/_regenerate_figures.py`)
